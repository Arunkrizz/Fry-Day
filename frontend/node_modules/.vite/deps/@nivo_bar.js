...
var b = function(t4) {
  var e5, i3 = t4.axis, n4 = t4.scale, r3 = t4.ticksPosition, a3 = t4.tickValues, l = t4.tickSize, s = t4.tickPadding, c2 = t4.tickRotation, f = t4.truncateTickAt, u2 = t4.engine, d2 = void 0 === u2 ? "svg" : u2, x2 = kn(n4, a3), h2 = fi[d2], g3 = "bandwidth" in n4 ? pn(n4) : n4, k4 = { lineX: 0, lineY: 0 }, v3 = { textX: 0, textY: 0 }, b3 = "object" == typeof document && "rtl" === document.dir, T4 = h2.align.center, P3 = h2.baseline.center;
  "x" === i3 ? (e5 = function(t5) {
    var e6;
...
var V = function(t4, e5) {
  ...
  if (w4.forEach(function(e6) {
    ...
    var n5 = C3(e6.value);
    t4.save(), t4.translate(e6.x + e6.textX, e6.y + e6.textY), t4.rotate(ni(k4)), Y3.outlineWidth > 0 && (t4.strokeStyle = Y3.outlineColor, t4.lineWidth = 2 * Y3.outlineWidth, t4.lineJoin = "round", t4.strokeText("" + n5, 0, 0)), W5.axis.ticks.text.fill && (t4.fillStyle = Y3.fill), t4.fillText("" + n5, 0, 0), t4.restore();
  }), void 0 !== p3) {
    var z4 = 0, V3 = 0, j3 = 0, D3 = "center";
    "y" === n4 ? (j3 = -90, z4 = A2, "start" === P3 ? (D3 = "start", V3 = f) : "middle" === P3 ? (D3 = "center", V3 = f / 2) : "end" === P3 && (D3 = "end")) : (V3 = A2, "start" === P3 ? D3 = "start" : "middle" === P3 ? (D3 = "center", z4 = f / 2) : "end" === P3 && (D3 = "end", z4 = f)), t4.translate(z4, V3), t4.rotate(ni(j3)), t4.font = (W5.axis.legend.text.fontWeight ? W5.axis.legend.text.fontWeight + " " : "") + W5.axis.legend.text.fontSize + "px " + W5.axis.legend.text.fontFamily, W5.axis.legend.text.fill && (t4.fillStyle = W5.axis.legend.text.fill), t4.textAlign = D3, t4.textBaseline = "middle", t4.fillText(p3, 0, 0);
  }
  t4.restore();
};
...
var ye = function(e5) {
  var a3 = e5.bars, i3 = e5.direction, t4 = e5.from, n4 = e5.groupMode, r3 = e5.layout, l = e5.legendLabel, o2 = e5.reverse, d2 = Bi(null != l ? l : "indexes" === t4 ? "indexValue" : "id");
...
var Le = function(i3) {
  ...
  }) }, "bars")), G.includes("grid") && (ca.grid = (0, import_jsx_runtime3.jsx)(z, { width: Ne, height: Je, xScale: P3 ? $e : null, yScale: X4 ? _e : null, xValues: Y3, yValues: D3 }, "grid")), G.includes("legends") && (ca.legends = (0, import_jsx_runtime3.jsx)(Q2, { width: Ne, height: Je, legends: la, toggleSerie: ra }, "legends")), G.includes("markers") && (ca.markers = (0, import_jsx_runtime3.jsx)(Ti, { markers: te2, width: Ne, height: Je, xScale: $e, yScale: _e }, "markers"));
  ...
  return (0, import_jsx_runtime3.jsx)(_i, { width: qe, height: ze, margin: Ke, defs: ua, role: Ie2, ariaLabel: Te, ariaLabelledBy: Re, ariaDescribedBy: He, isFocusable: Ee, children: G.map(function(e5, a3) {
    var i4;
...
var Ve = function(e5, a3, i3, t4) {
  return e5.find(function(e6) {
    return Ai(e6.x + a3.left, e6.y + a3.top, e6.width, e6.height, i3, t4);
  });
};
var We2 = function(e5) {
  ...
  var _e = (0, import_react3.useCallback)(function(e6) {
    if (Ye && Be2.current) {
      var a4 = Fi(Be2.current, e6), i3 = a4[0], t4 = a4[1], n4 = Ve(Ye, Re, i3, t4);
